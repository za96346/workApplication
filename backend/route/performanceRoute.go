...
func Performance(props *gin.RouterGroup) {
	props.Use(middleWare.TokenPrase)
	{
		...
		props.PUT("/performance", middleWare.Permession(100, 1, 2), worker.AssignWorker(42))
		props.DELETE("/performance", middleWare.Permession(100, 1, 2), worker.AssignWorker(43))
