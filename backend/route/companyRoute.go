...
func Company(props *gin.RouterGroup) {
	props.Use(middleWare.TokenPrase)
	{
		...
		// banch all
		props.GET("/banch/all", middleWare.MyCompanyAndBanch(true), worker.AssignWorker(8))
		props.PUT("/banch/all",
			middleWare.Permession(100),
			middleWare.MyCompanyAndBanch(true),
		...
		// banch style
		props.GET("/banch/style", middleWare.MyCompanyAndBanch(true), worker.AssignWorker(9))
		...
		// banch rule
		props.GET("/banch/rule", middleWare.MyCompanyAndBanch(true), worker.AssignWorker(10))
